"""information-hub — Obsidian markdown view generator.

Builds the human-readable .md for a record: YAML frontmatter,
wikilinked entities, and a Related section with links to related items.
"""
